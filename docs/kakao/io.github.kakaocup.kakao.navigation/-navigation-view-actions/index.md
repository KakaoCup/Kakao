//[kakao](../../../index.md)/[io.github.kakaocup.kakao.navigation](../index.md)/[NavigationViewActions](index.md)



# NavigationViewActions  
 [androidJvm] interface [NavigationViewActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.navigation/NavigationViewActions/navigateTo/#kotlin.Int/PointingToDeclaration/"></a>[navigateTo](navigate-to.md)| <a name="io.github.kakaocup.kakao.navigation/NavigationViewActions/navigateTo/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [navigateTo](navigate-to.md)(id: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Clicks on the navigation view menu item with given id  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.navigation/NavigationViewActions/view/#/PointingToDeclaration/"></a>[view](index.md#369122861%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.navigation/NavigationViewActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#369122861%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.navigation/KNavigationView///PointingToDeclaration/"></a>[KNavigationView](../-k-navigation-view/index.md)|
