[kakao](../../index.md) / [io.github.kakaoandroid.kakao.spinner](../index.md) / [KSpinnerItem](./index.md)

# KSpinnerItem

`class KSpinnerItem : `[`KAdapterItem`](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/index.md)`<`[`KTextView`](../../io.github.kakaoandroid.kakao.text/-k-text-view/index.md)`>, `[`TextViewAssertions`](../../io.github.kakaoandroid.kakao.text/-text-view-assertions/index.md)
...
| Name | Summary |
|---|---|
| [root](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/root.md) | `open var root: Matcher<Root!>!` |
| [view](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/view.md) | `open val view: `[`ViewInteractionDelegate`](../../io.github.kakaoandroid.kakao.delegate/-view-interaction-delegate/index.md) |
...
| [invoke](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/invoke.md) | `operator fun invoke(function: `[`T`](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/index.md#T)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)<br>Operator that allows usage of DSL style |
| [perform](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/perform.md) | `infix fun perform(function: `[`T`](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/index.md#T)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`): `[`T`](../../io.github.kakaoandroid.kakao.list/-k-adapter-item/index.md#T)<br>Infix function for invoking lambda on your view |
