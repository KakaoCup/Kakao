[kakao](../../index.md) / [io.github.kakaoandroid.kakao.pager](../index.md) / [KViewPager](./index.md)

# KViewPager

`class KViewPager : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KViewPager`](./index.md)`>, `[`SwipeableActions`](../../io.github.kakaoandroid.kakao.common.actions/-swipeable-actions/index.md)`, `[`ViewPagerAssertions`](../-view-pager-assertions/index.md)
