[kakao](../index.md) / [io.github.kakaoandroid.kakao.toolbar](index.md) / [ToolbarViewActions](./-toolbar-view-actions.md)

# ToolbarViewActions

`interface ToolbarViewActions : `[`BaseActions`](../io.github.kakaoandroid.kakao.common.actions/-base-actions/index.md)
