[kakao](../../index.md) / [io.github.kakaoandroid.kakao.edit](../index.md) / [KEditText](./index.md)

# KEditText

`class KEditText : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KEditText`](./index.md)`>, `[`EditableActions`](../-editable-actions/index.md)`, `[`TextViewAssertions`](../../io.github.kakaoandroid.kakao.text/-text-view-assertions/index.md)
