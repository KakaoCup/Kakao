[kakao](../../index.md) / [io.github.kakaoandroid.kakao.edit](../index.md) / [KTextInputLayout](./index.md)

# KTextInputLayout

`class KTextInputLayout : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KTextInputLayout`](./index.md)`>, `[`TextInputLayoutAssertions`](../-text-input-layout-assertions/index.md)
