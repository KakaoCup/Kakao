...
# CheckableActions  
 [androidJvm] interface [CheckableActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.check/CheckableActions/setChecked/#kotlin.Boolean/PointingToDeclaration/"></a>[setChecked](set-checked.md)| <a name="io.github.kakaocup.kakao.check/CheckableActions/setChecked/#kotlin.Boolean/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [setChecked](set-checked.md)(checked: [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html))  <br>More info  <br>Sets checked state of the view  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.check/CheckableActions/view/#/PointingToDeclaration/"></a>[view](index.md#1734486694%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.check/CheckableActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#1734486694%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.check/KCheckBox///PointingToDeclaration/"></a>[KCheckBox](../-k-check-box/index.md)|
