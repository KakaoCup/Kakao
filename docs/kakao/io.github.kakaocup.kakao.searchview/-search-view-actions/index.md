[kakao](../../index.md) / [io.github.kakaocup.kakao.searchview](../index.md) / [SearchViewActions](./index.md)

# SearchViewActions

`interface SearchViewActions : `[`BaseActions`](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| Name | Summary |
|---|---|
| [KSearchView](../-k-search-view/index.md) | `class KSearchView : `[`KBaseView`](../../io.github.kakaocup.kakao.common.views/-k-base-view/index.md)`<`[`KSearchView`](../-k-search-view/index.md)`>, `[`SearchViewActions`](./index.md)`, `[`SearchViewAssertions`](../-search-view-assertions/index.md) |
