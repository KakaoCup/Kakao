[kakao](../../index.md) / [io.github.kakaocup.kakao.rating](../index.md) / [KRatingBar](./index.md)

# KRatingBar

`class KRatingBar : `[`KBaseView`](../../io.github.kakaocup.kakao.common.views/-k-base-view/index.md)`<`[`KRatingBar`](./index.md)`>, `[`RatingBarActions`](../-rating-bar-actions/index.md)`, `[`RatingBarAssertions`](../-rating-bar-assertions/index.md)
