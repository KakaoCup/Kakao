[kakao](../../index.md) / [io.github.kakaocup.kakao.tabs](../index.md) / [KTabLayout](./index.md)

# KTabLayout

`class KTabLayout : `[`KBaseView`](../../io.github.kakaocup.kakao.common.views/-k-base-view/index.md)`<`[`KTabLayout`](./index.md)`>, `[`TabLayoutActions`](../-tab-layout-actions/index.md)`, `[`TabLayoutAssertions`](../-tab-layout-assertions/index.md)
