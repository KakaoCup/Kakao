[kakao](../../index.md) / [io.github.kakaoandroid.kakao.check](../index.md) / [KCheckBox](./index.md)

# KCheckBox

`class KCheckBox : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KCheckBox`](./index.md)`>, `[`CheckableActions`](../-checkable-actions/index.md)`, `[`TextViewAssertions`](../../io.github.kakaoandroid.kakao.text/-text-view-assertions/index.md)`, `[`CheckableAssertions`](../-checkable-assertions/index.md)
