//[kakao](../../../index.md)/[io.github.kakaocup.kakao.drawer](../index.md)/[DrawerActions](index.md)



# DrawerActions  
 [androidJvm] interface [DrawerActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/close/#kotlin.Int/PointingToDeclaration/"></a>[close](close.md)| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/close/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [close](close.md)(gravity: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) = Gravity.START)  <br>More info  <br>Closes the navigation drawer  <br><br><br>|
...
| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/open/#kotlin.Int/PointingToDeclaration/"></a>[open](open.md)| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/open/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [open](open.md)(gravity: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html) = Gravity.START)  <br>More info  <br>Opens the navigation drawer  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/view/#/PointingToDeclaration/"></a>[view](index.md#-1181331470%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.drawer/DrawerActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#-1181331470%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.drawer/KDrawerView///PointingToDeclaration/"></a>[KDrawerView](../-k-drawer-view/index.md)|
