...
`interface DrawerActions : `[`BaseActions`](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| Name | Summary |
|---|---|
| [KDrawerView](../-k-drawer-view/index.md) | `class KDrawerView : `[`KBaseView`](../../io.github.kakaocup.kakao.common.views/-k-base-view/index.md)`<`[`KDrawerView`](../-k-drawer-view/index.md)`>, `[`DrawerActions`](./index.md)<br>View with DrawerActions and BaseAssertions |
