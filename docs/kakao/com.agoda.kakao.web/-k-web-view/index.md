[kakao](../../index.md) / [io.github.kakaoandroid.kakao.web](../index.md) / [KWebView](./index.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `KWebView(matcher: (`[`ViewBuilder`](../../io.github.kakaoandroid.kakao.common.builders/-view-builder/index.md)`.() -> `[`Unit`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-unit/index.html)`)? = null)`<br>Class for interacting with WebViews |
