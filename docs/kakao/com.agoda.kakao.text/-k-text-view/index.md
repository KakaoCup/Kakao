[kakao](../../index.md) / [io.github.kakaoandroid.kakao.text](../index.md) / [KTextView](./index.md)

# KTextView

`class KTextView : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KTextView`](./index.md)`>, `[`TextViewActions`](../-text-view-actions/index.md)`, `[`TextViewAssertions`](../-text-view-assertions/index.md)
