[kakao](../../index.md) / [io.github.kakaocup.kakao.progress](../index.md) / [KProgressBar](./index.md)

# KProgressBar

`class KProgressBar : `[`KBaseView`](../../io.github.kakaocup.kakao.common.views/-k-base-view/index.md)`<`[`KProgressBar`](./index.md)`>, `[`ProgressBarActions`](../-progress-bar-actions/index.md)`, `[`ProgressBarAssertions`](../-progress-bar-assertions/index.md)
