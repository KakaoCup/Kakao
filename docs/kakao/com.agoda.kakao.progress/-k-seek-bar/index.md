[kakao](../../index.md) / [io.github.kakaoandroid.kakao.progress](../index.md) / [KSeekBar](./index.md)

# KSeekBar

`class KSeekBar : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KSeekBar`](./index.md)`>, `[`SeekBarActions`](../-seek-bar-actions/index.md)`, `[`ProgressBarAssertions`](../-progress-bar-assertions/index.md)
