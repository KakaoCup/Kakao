[kakao](../../index.md) / [io.github.kakaoandroid.kakao.scroll](../index.md) / [KScrollView](./index.md)

# KScrollView

`class KScrollView : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KScrollView`](./index.md)`>, `[`ScrollViewActions`](../-scroll-view-actions/index.md)`, `[`BaseAssertions`](../../io.github.kakaoandroid.kakao.common.assertions/-base-assertions/index.md)
