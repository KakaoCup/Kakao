[kakao](../../index.md) / [io.github.kakaoandroid.kakao.picker.time](../index.md) / [TimePickerAction](./index.md)

# TimePickerAction

`interface TimePickerAction : `[`BaseActions`](../../io.github.kakaoandroid.kakao.common.actions/-base-actions/index.md)
...
| Name | Summary |
|---|---|
| [setTime](set-time.md) | `open fun setTime(hour: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`, minutes: `[`Int`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)`): `[`ViewInteractionDelegate`](../../io.github.kakaoandroid.kakao.delegate/-view-interaction-delegate/index.md)<br>Set time to picker dialog |
...
| Name | Summary |
|---|---|
| [KTimePicker](../-k-time-picker/index.md) | `class KTimePicker : `[`KBaseView`](../../io.github.kakaoandroid.kakao.common.views/-k-base-view/index.md)`<`[`KTimePicker`](../-k-time-picker/index.md)`>, `[`TimePickerAction`](./index.md)`, `[`TimePickerAssertion`](../-time-picker-assertion/index.md)<br>View for interact with default time picker |
