[kakao](../../index.md) / [io.github.kakaoandroid.kakao](../index.md) / [BottomNavigationViewActions](./index.md)

# BottomNavigationViewActions

`interface BottomNavigationViewActions : `[`BaseActions`](../-base-actions/index.md)
