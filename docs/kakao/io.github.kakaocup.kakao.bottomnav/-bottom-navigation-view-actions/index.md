...
# BottomNavigationViewActions  
 [androidJvm] interface [BottomNavigationViewActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.bottomnav/BottomNavigationViewActions/setSelectedItem/#kotlin.Int/PointingToDeclaration/"></a>[setSelectedItem](set-selected-item.md)| <a name="io.github.kakaocup.kakao.bottomnav/BottomNavigationViewActions/setSelectedItem/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [setSelectedItem](set-selected-item.md)(id: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Sets the given item id as selected  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.bottomnav/BottomNavigationViewActions/view/#/PointingToDeclaration/"></a>[view](index.md#1969552688%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.bottomnav/BottomNavigationViewActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#1969552688%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.bottomnav/KBottomNavigationView///PointingToDeclaration/"></a>[KBottomNavigationView](../-k-bottom-navigation-view/index.md)|
