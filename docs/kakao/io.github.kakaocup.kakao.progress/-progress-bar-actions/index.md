//[kakao](../../../index.md)/[io.github.kakaocup.kakao.progress](../index.md)/[ProgressBarActions](index.md)



# ProgressBarActions  
 [androidJvm] interface [ProgressBarActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.progress/ProgressBarActions/setProgress/#kotlin.Int/PointingToDeclaration/"></a>[setProgress](set-progress.md)| <a name="io.github.kakaocup.kakao.progress/ProgressBarActions/setProgress/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [setProgress](set-progress.md)(number: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Set progress for ProgressBar  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.progress/ProgressBarActions/view/#/PointingToDeclaration/"></a>[view](index.md#-1800699897%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.progress/ProgressBarActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#-1800699897%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
| <a name="io.github.kakaocup.kakao.progress/SeekBarActions///PointingToDeclaration/"></a>[SeekBarActions](../-seek-bar-actions/index.md)|
