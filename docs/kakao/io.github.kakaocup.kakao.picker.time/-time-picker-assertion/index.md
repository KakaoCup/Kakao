...
# TimePickerAssertion  
 [androidJvm] interface [TimePickerAssertion](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasHour/#kotlin.Int/PointingToDeclaration/"></a>[hasHour](has-hour.md)| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasHour/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [hasHour](has-hour.md)(hour: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Check if picker dialog contain selected hour  <br><br><br>|
| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasMinute/#kotlin.Int/PointingToDeclaration/"></a>[hasMinute](has-minute.md)| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasMinute/#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [hasMinute](has-minute.md)(minute: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Check if picker dialog contain selected minute  <br><br><br>|
| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasTime/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[hasTime](has-time.md)| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/hasTime/#kotlin.Int#kotlin.Int/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [hasTime](has-time.md)(hour: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html), minute: [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html))  <br>More info  <br>Check if picker dialog contain selected time  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/view/#/PointingToDeclaration/"></a>[view](index.md#-67514285%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.picker.time/TimePickerAssertion/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#-67514285%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.picker.time/KTimePicker///PointingToDeclaration/"></a>[KTimePicker](../-k-time-picker/index.md)|
