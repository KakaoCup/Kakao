...
# SliderActions  
 [androidJvm] interface [SliderActions](index.md) : [BaseActions](../../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
...
| <a name="io.github.kakaocup.kakao.slider/SliderActions/dragValueTo/#kotlin.Float/PointingToDeclaration/"></a>[dragValueTo](drag-value-to.md)| <a name="io.github.kakaocup.kakao.slider/SliderActions/dragValueTo/#kotlin.Float/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [dragValueTo](drag-value-to.md)(value: [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html))  <br>More info  <br>Drags slider to defined position.  <br><br><br>|
...
| <a name="io.github.kakaocup.kakao.slider/SliderActions/setValue/#kotlin.Float/PointingToDeclaration/"></a>[setValue](set-value.md)| <a name="io.github.kakaocup.kakao.slider/SliderActions/setValue/#kotlin.Float/PointingToDeclaration/"></a>[androidJvm]  <br>Content  <br>open fun [setValue](set-value.md)(value: [Float](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-float/index.html))  <br>More info  <br>Set value for Slider  <br><br><br>|
...
|  Name |  Summary | 
|---|---|
| <a name="io.github.kakaocup.kakao.slider/SliderActions/view/#/PointingToDeclaration/"></a>[view](index.md#735075826%2FProperties%2F34310170)| <a name="io.github.kakaocup.kakao.slider/SliderActions/view/#/PointingToDeclaration/"></a> [androidJvm] abstract val [view](index.md#735075826%2FProperties%2F34310170): [ViewInteractionDelegate](../../io.github.kakaocup.kakao.delegate/-view-interaction-delegate/index.md)   <br>|
...
|  Name | 
|---|
| <a name="io.github.kakaocup.kakao.slider/KSlider///PointingToDeclaration/"></a>[KSlider](../-k-slider/index.md)|
