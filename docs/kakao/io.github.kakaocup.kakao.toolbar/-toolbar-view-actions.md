[kakao](../index.md) / [io.github.kakaocup.kakao.toolbar](index.md) / [ToolbarViewActions](./-toolbar-view-actions.md)

# ToolbarViewActions

`interface ToolbarViewActions : `[`BaseActions`](../io.github.kakaocup.kakao.common.actions/-base-actions/index.md)
